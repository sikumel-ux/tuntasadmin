...
// FIX: SARING DROPDOWN INPUT IURAN DENGAN TOLERANSI HURUF BESAR/KECIL
function saringDropdownWargaBerdasarkanTipe() {
    ...
    Object.keys(MEMORI_WARGA_GLOBAL).forEach(key => {
        ...
        // Mengubah string tipe dari database menjadi lowercase agar sinkron saat pencocokan
...
// FIX: DROPDOWN LAPORAN SAMPAH OPERASIONAL
...
// ==========================================
// PENERBITAN IURAN & ALUR KUITANSI TERPISAH
// ==========================================
function simpanIuran(e) {
    ...
    if (tipe === 'pon') {
        ...
        // Histori kas Anggota Tetap
        formatKasHistori = `${nWarga} - ${bPeriode}`;
        
        // Narasi khusus kuitansi terpisah untuk kuitansi.html
