...
// EDIT: Ditambahkan detektor error CORS / Offline pada Fetching data Warga
async function muatSistemWarga() {
    ...
    try {
        ...
        // Tampilkan error log rinci langsung di elemen listWarga aplikasi Anda
        list.innerHTML = `
            <div class="p-4 text-center bg-rose-50 rounded-xl border border-rose-100">
                ...
                <span class="text-[8px] text-slate-400 block mt-1">Coba jalankan dengan 'Live Server' atau cek internet Anda.</span>
            </div>`;
    }
}
